 ...
 */
public class CustomAntUrlPathMatcher implements UrlMatcher {
    private boolean requiresLowerCaseUrl = true;
    private CustomAntPathMatcher pathMatcher = new CustomAntPathMatcher();

    public CustomAntUrlPathMatcher() {
        this(true);
    }

    public CustomAntUrlPathMatcher(boolean requiresLowerCaseUrl) {
    ...
    public boolean pathMatchesUrl(String pattern, String url, String[] pattDirs, String[] pathDirs) {
        if ("/**".equals(pattern) || "**".equals(pattern)) {
            return true;
        }
        return pathMatcher.match(pattern, url, pattDirs, pathDirs);
    }
    ...
    private class CustomAntPathMatcher implements PathMatcher {
        ...
        public boolean match(String pattern, String path, String[] pattDirs, String[] pathDirs) {
            return doMatch(pattern, path, true, null, pattDirs, pathDirs);
        }
        ...
        protected boolean doMatch(String pattern, String path, boolean fullMatch,
            ...
            return doMatch(pattern, path, fullMatch, uriTemplateVariables, pattDirs, pathDirs);
        }

        protected boolean doMatch(String pattern, String path, boolean fullMatch,
                                  Map<String, String> uriTemplateVariables, String[] pattDirs, String[] pathDirs) {
